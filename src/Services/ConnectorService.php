...
namespace Mhassan654\LicensingConnector\Services;

use Illuminate\Support\Facades\Http;
use Illuminate\Support\Facades\Cache;
use Illuminate\Support\Facades\Config;

use Mhassan654\LicensingConnector\Traits\CacheKeys;
use Mhassan654\LicensingConnector\Exceptions\AuthException;
...
class ConnectorService
{
    ...
    {
        if ($this->accessToken) {
            $url = Config::get('licensing-connector.license_server_url') . '/api/license-server/license';
    ...
    private function getAccessToken(string $licenseKey): null | string
    {
        ...
        $url = Config::get('licensing-connector.license_server_url') . '/api/license-server/auth/login';
